...
# Resolve records.json relative to this module so functions find it even when
# the process current working directory is different (e.g., when Flask runs).
JSONDATA = Path(__file__).resolve().parent / "records.json"
